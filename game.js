class TitleScene extends Phaser.Scene {
    ...
    showoptions(title, playButton, optionsButton, creditsButton) {
        ...
        soundBarBackground.fillRect(
            this.cameras.main.centerX - barWidth / 2 - barWidth * 0.2, 
            this.cameras.main.centerY - 65 - barHeight * 2, 
            barWidth + barWidth * 0.4, 
            barHeight + 50
        );

        soundBarBackground.lineStyle(2, 0xFFFFFF, 1); 
        soundBarBackground.strokeRect(
            this.cameras.main.centerX - barWidth / 2 - barWidth * 0.2, 
            this.cameras.main.centerY - 65 - barHeight * 2, 
            barWidth + barWidth * 0.4, 
            barHeight + 50
        ...
        let sphere = this.add.circle(
            this.cameras.main.centerX - barWidth / 2 + (gamevolume * barWidth),
            this.cameras.main.centerY - 60 + barHeight / 2,
            sphereRadius,
            0x007FFF
        ).setInteractive();
        this.input.setDraggable(sphere);

        let volumeText = this.add.text(
            this.cameras.main.centerX,
            this.cameras.main.centerY + 30,
            `Volume: ${Math.round(gamevolume * 100)}%`,
            { fontSize: '24px', fill: '#FFF', fontFamily: 'Comic Sans MS, sans-serif' }
        ).setOrigin(0.5);

        sphere.on('drag', (pointer, dragX) => {
            dragX = Phaser.Math.Clamp(dragX, this.cameras.main.centerX - barWidth / 2, this.cameras.main.centerX + barWidth / 2);
            sphere.x = dragX;

            gamevolume = (dragX - (this.cameras.main.centerX - barWidth / 2)) / barWidth * maxVolume;
            gamevolume = Phaser.Math.Clamp(gamevolume, 0, maxVolume);
...
class Barracuda extends Phaser.Scene {
    constructor() {
        super({
            key: 'Barracuda',
            physics: {
        ...
        this.laneColors = [0x8B0000, 0xFF2400, 0xB22222, 0xFF0000]
        this.isPaused = false;
        this.pauseMenu = null;
        this.music = null;
        this.musicStarted = false;
    ...
    preload() {
        ...
        this.load.audio('SRANKSOUND', 'Sranksound.mp3');
        this.load.audio('ARANKSOUND', 'Aranksound.mp3');
        this.load.audio('gameomusic1', 'Level0-track.m4a');
        this.load.audio('LevelFailed', 'LEVELFAILED.mp3');
        this.load.image('pausebutton', 'pausebutton.png');
        this.load.image('exitbutton', 'exitbutton.png');
        this.load.image('unpausebutton', 'unpausebutton.png');
    ...
    create() {
        ...
        if (!this.music) {
            this.music = this.sound.add('gameomusic1', {volume: gamevolume});
        }
        ...
        this.beatmap = [
          ...
          { time: 2 * beatInterval, lane: 0 },
          { time: 3 * beatInterval, lane: 0 },
          { time: 4 * beatInterval, lane: 0 },
          { time: 5 * beatInterval, lane: 1 },
          { time: 6 * beatInterval, lane: 0 },
          { time: 7 * beatInterval, lane: 0 },
          { time: 8 * beatInterval, lane: 0 },
          { time: 9 * beatInterval, lane: 1 },
          { time: 10 * beatInterval, lane: 0 },
          { time: 11 * beatInterval, lane: 2 },
          { time: 12 * beatInterval, lane: 2 },
          { time: 13 * beatInterval, lane: 2 },
          { time: 14 * beatInterval, lane: 3 },
          { time: 15 * beatInterval, lane: 0 },
          { time: 16 * beatInterval, lane: 1 },
          { time: 17 * beatInterval, lane: 2 },
          { time: 18 * beatInterval, lane: 2 },
          { time: 19 * beatInterval, lane: 2 },
          { time: 20 * beatInterval, lane: 1 },
          { time: 21 * beatInterval, lane: 2 },
          { time: 22 * beatInterval, lane: 1 },
          { time: 23 * beatInterval, lane: 1 },
          { time: 24 * beatInterval, lane: 1 },
          { time: 25 * beatInterval, lane: 3 },
          { time: 26 * beatInterval, lane: 3 },
          { time: 27 * beatInterval, lane: 3 },
          { time: 28 * beatInterval, lane: 2 },
          { time: 29 * beatInterval, lane: 1 },
          { time: 30 * beatInterval, lane: 2 },
          { time: 31 * beatInterval, lane: 2 },
          { time: 32 * beatInterval, lane: 2 },
          { time: 33 * beatInterval, lane: 1 },
          { time: 34 * beatInterval, lane: 2 },
          { time: 35 * beatInterval, lane: 1 },
          ...
          { time: 100 * beatInterval, lane: 0 },
            { time: 101 * beatInterval, lane: 3 },
              { time: 102 * beatInterval, lane: 3 },
              { time: 103 * beatInterval, lane: 3 },
              { time: 104 * beatInterval, lane: 3 },
            { time: 105 * beatInterval, lane: 0 },
              { time: 106 * beatInterval, lane: 0 },
              { time: 107 * beatInterval, lane: 0 },
              { time: 108 * beatInterval, lane: 0 },
            { time: 109 * beatInterval, lane: 1 },
              { time: 109.5 * beatInterval, lane: 2 },
              { time: 110 * beatInterval, lane: 1 },
              { time: 110.5 * beatInterval, lane: 2 },
            { time: 111 * beatInterval, lane: 1 },
              { time: 111.5 * beatInterval, lane: 2 },
              { time: 112 * beatInterval, lane: 1 },
            ...
            { time: 113 * beatInterval, lane: 0 },
              ...
              { time: 116 * beatInterval, lane: 0 },
                { time: 117 * beatInterval, lane: 3 },
                  ...
                  { time: 119 * beatInterval, lane: 3 },
                  { time: 120 * beatInterval, lane: 3 },
                { time: 121 * beatInterval, lane: 1 },
                  { time: 122 * beatInterval, lane: 3 },
                  { time: 123 * beatInterval, lane: 2 },
                  { time: 124 * beatInterval, lane: 0 },
                { time: 125 * beatInterval, lane: 1 },
                ...
                { time: 127 * beatInterval, lane: 1 },
                  { time: 127.5 * beatInterval, lane: 2 },
                  { time: 128 * beatInterval, lane: 1 },
                  { time: 128.5 * beatInterval, lane: 2 },
            { time: 129 * beatInterval, lane: 3 },
              { time: 130 * beatInterval, lane: 3 },
              { time: 131 * beatInterval, lane: 3 },
              { time: 132 * beatInterval, lane: 3 },
                { time: 133 * beatInterval, lane: 0 },
                  { time: 134 * beatInterval, lane: 0 },
                  { time: 135 * beatInterval, lane: 0 },
                  { time: 136 * beatInterval, lane: 0 },
                { time: 137 * beatInterval, lane: 3 },
                  { time: 138 * beatInterval, lane: 3 },
                  { time: 139 * beatInterval, lane: 3 },
                  { time: 140 * beatInterval, lane: 3 },
                { time: 141 * beatInterval, lane: 2 },
                  { time: 141.5 * beatInterval, lane: 1 },
                  { time: 142 * beatInterval, lane: 2 },
                  { time: 142.5 * beatInterval, lane: 1 },
                ...
                { time: 145 * beatInterval, lane: 3 },
                  { time: 146 * beatInterval, lane: 3 },
                  { time: 147 * beatInterval, lane: 3 },
                  { time: 148 * beatInterval, lane: 3 },
                    { time: 149 * beatInterval, lane: 0 },
                      { time: 150 * beatInterval, lane: 0 },
                      { time: 151 * beatInterval, lane: 0 },
                      { time: 152 * beatInterval, lane: 0 },
                    { time: 153 * beatInterval, lane: 1 },
                      { time: 154 * beatInterval, lane: 3 },
                      { time: 155 * beatInterval, lane: 2 },
                      { time: 156 * beatInterval, lane: 0 },
                    { time: 157 * beatInterval, lane: 1 },
                      { time: 157.5 * beatInterval, lane: 2 },
                      { time: 158 * beatInterval, lane: 1 },
                      { time: 158.5 * beatInterval, lane: 2 },
                    { time: 159 * beatInterval, lane: 1 },
                      { time: 159.5 * beatInterval, lane: 2 },
                      { time: 160 * beatInterval, lane: 1 },
                      { time: 160.5 * beatInterval, lane: 2 },
                      { time: 161 * beatInterval, lane: 1 },
                      { time: 162 * beatInterval, lane: 0 },
                      ...
                      { time: 170 * beatInterval, lane: 0 },
                      { time: 171 * beatInterval, lane: 2 },
                      { time: 172 * beatInterval, lane: 3 },
                      { time: 173 * beatInterval, lane: 2 },
                      { time: 174 * beatInterval, lane: 3 },
                      { time: 175 * beatInterval, lane: 0 },
                      { time: 176 * beatInterval, lane: 1 },
                      { time: 177 * beatInterval, lane: 2 },
                      { time: 178 * beatInterval, lane: 3 },
                      { time: 179 * beatInterval, lane: 2 },
                      { time: 180 * beatInterval, lane: 1 },
                      { time: 181 * beatInterval, lane: 2 },
                      { time: 182 * beatInterval, lane: 1 },
                      { time: 183 * beatInterval, lane: 0 },
                      { time: 184 * beatInterval, lane: 1 },
                      { time: 185 * beatInterval, lane: 3 },
                      ...
                      { time: 191 * beatInterval, lane: 1 },
                      { time: 192 * beatInterval, lane: 2 },
                      { time: 193 * beatInterval, lane: 1 },
                      { time: 194 * beatInterval, lane: 2 },
                      { time: 195 * beatInterval, lane: 1 },
            { time: 196 * beatInterval, lane: 0 },
              { time: 197 * beatInterval, lane: 1 },
              { time: 198 * beatInterval, lane: 0 },
              { time: 199 * beatInterval, lane: 2 },
              ...
              { time: 206 * beatInterval, lane: 3 },
              { time: 207 * beatInterval, lane: 2 },
              { time: 208 * beatInterval, lane: 3 },
              { time: 209 * beatInterval, lane: 0 },
              { time: 210 * beatInterval, lane: 1 },
              { time: 211 * beatInterval, lane: 2 },
              { time: 212 * beatInterval, lane: 3 },
              { time: 213 * beatInterval, lane: 2 },
              { time: 214 * beatInterval, lane: 1 },
              { time: 215 * beatInterval, lane: 2 },
              { time: 216 * beatInterval, lane: 1 },
              { time: 217 * beatInterval, lane: 0 },
              { time: 218 * beatInterval, lane: 1 },
              { time: 219 * beatInterval, lane: 3 },
              { time: 220 * beatInterval, lane: 2 },
              { time: 221 * beatInterval, lane: 1 },
              { time: 222 * beatInterval, lane: 1 },
    ...
    createStarPop(height = 200, xposition = 0, yposition = 0, duration = 1000, starCount = 5) {
        ...
        for (let i = 0; i < starCount; i++) {
            ...
            this.tweens.add({
                targets: triangle,
                angle: triangle.angle + Phaser.Math.Between(10, 360),
                duration: duration,
                ease: 'Linear',
                repeat: -1
            });
    ...
    boxPop(size = 50, duration = 1000) {
        ...
        let randomColor = Phaser.Utils.Array.GetRandom([0xFF6347, 0xFF4500, 0xB22222, 0x8B0000]);
        ...
        triangle.lineStyle(4, randomColor, 1);
        triangle.strokeTriangle(-size / 2, -size / 2, size / 2, size / 2, size, 0);
        triangle.setPosition(randomX, randomY);
        triangle.setRotation(Phaser.Math.DegToRad(randomAngle));
        triangle.setAlpha(1);
        ...
        this.tweens.add({
            ...
            onComplete: () => {
                for (let i = 0; i < 5; i++) {
                    let piece = this.add.polygon(
                        randomX, 
                        randomY, 
                        [0, 10, 5, 0, 10, 10], 
                        Phaser.Utils.Array.GetRandom([0xFF6347, 0xFF4500, 0xB22222, 0x8B0000])
                    );

                    this.tweens.add({
                        targets: piece,
                        x: randomX + Phaser.Math.Between(-50, 50),
                        y: randomY + Phaser.Math.Between(-50, 50),
                        alpha: 0,
                        duration: duration / 2,
                        ease: 'Power1',
                        onComplete: () => {
...
class Planetloop extends Phaser.Scene {
    ...
    reduceRedBar(reductionAmount = 50) {
        this.redBarWidth -= reductionAmount;
        if (this.redBarWidth < 0) this.redBarWidth = 0;
...
class FinalBoss extends Phaser.Scene {
    ...
    create() {
        ...
        this.beatmap = [
          ...
          { time: 172 * beatInterval, lane: 3 },
          { time: 172.4 * beatInterval, lane: 0 },
          { time: 172.8 * beatInterval, lane: 1 },
          { time: 173 * beatInterval, lane: 3 },
        ...
        //FIGHT!
          ...
          { time: 460 * beatInterval, lane: 3 },
          { time: 461 * beatInterval, lane: 3 },
          { time: 461.4 * beatInterval, lane: 0 },
          { time: 461.8 * beatInterval, lane: 1 },
        ...
        //closing
          { time: 609 * beatInterval, lane: 1 },
          { time: 610 * beatInterval, lane: 0 },
          { time: 611 * beatInterval, lane: 0 },
          { time: 612 * beatInterval, lane: 1 },
          { time: 613 * beatInterval, lane: 1 },
          { time: 614 * beatInterval, lane: 0 },
          { time: 615 * beatInterval, lane: 0 },
          { time: 616 * beatInterval, lane: 1 },
          { time: 617 * beatInterval, lane: 1 },
          { time: 618 * beatInterval, lane: 0 },
          { time: 619 * beatInterval, lane: 0 },
          { time: 620 * beatInterval, lane: 1 },
          { time: 621 * beatInterval, lane: 1 },
          { time: 622 * beatInterval, lane: 0 },
          { time: 623 * beatInterval, lane: 0 },
          { time: 624 * beatInterval, lane: 1 },
          { time: 625 * beatInterval, lane: 1 },
          ...
          { time: 644 * beatInterval, lane: 0 },
          { time: 645 * beatInterval, lane: 2 },
          { time: 646 * beatInterval, lane: 1 },
          ...
          { time: 654 * beatInterval, lane: 0 },
          { time: 655 * beatInterval, lane: 2 },
          { time: 656 * beatInterval, lane: 1 },
          ...
          { time: 664 * beatInterval, lane: 0 },
          { time: 665 * beatInterval, lane: 2 },
          { time: 666 * beatInterval, lane: 2 },
          { time: 667 * beatInterval, lane: 2 },
          { time: 668 * beatInterval, lane: 1 },
        ...
        this.beatmap.forEach((note, index) => {
            this.time.addEvent({
                ...
                callback: () => {
                    ...
                    if (index === 1 || index === 434 || index === 937 || index === 1068 ) {
                        this.boxPop(260, 3500);  
                    }
                    ...
                    if (index === 249 || index === 260 || index === 270 || index === 277 || index === 281 || index === 297 || index === 307 || index === 317 || index === 321 || index === 753 || index === 764 || index === 774 || index === 784 || index === 794 || index === 804 || index === 813 || index === 824 ){
    ...
    reduceRedBar(reductionAmount = 120) {
        this.redBarWidth -= reductionAmount;
        if (this.redBarWidth < 0) this.redBarWidth = 0;
...
const config = {
  ...
  scene: [TitleScene, FinalBoss, Barracuda, Usagiflap, Planetloop],
  physics: {
    default: 'matter',
    matter: {
      gravity: { y: 0.5 },
